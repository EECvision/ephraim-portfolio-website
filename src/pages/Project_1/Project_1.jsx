...
import cx from './Project_1.module.css';
import projectData from '../../state/DATA.json';
import { useHistory } from "react-router-dom";

const ProjectOne = ({ setCurrentPage, activeProject, currentPage }) => {

  const { projectTitle, mainColor } = projectData[activeProject]
  ...
  return (
    <div id="container" onScroll={handlePageScroll} className={`${cx.container}`}>
      ...
      <div className={`${cx.wrapper} ${close && cx.hide}`}>
        ...
        <div className={cx.contentWrapper}>
          <div id="projectContent" className={cx.content}>
            <div></div>
            <div></div>
            <div></div>
            <div></div>
