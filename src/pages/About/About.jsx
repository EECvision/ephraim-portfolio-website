      ...
      <nav className={cx.nav}>
        ...
        <div className={cx.emailContainer}>
          ...
          <input
            ...
            ref={clipboardRef}
            type="text"
            defaultValue={"ephraimsopuruchukwu@gmail.com"}
          />
        </div>
      </nav>
      ...
      <div className={`${cx.aboutContainer} ${view && cx.view}`}>
        <section className={cx.profile}>
          ...
          <div className={cx.info}>
            ...
            <p className={cx.about}>
              ...
              useful, and delightful user experiences. <br />I prioritize
              centering design processes around users when designing to solve
              complex problems that help businesses grow.
            </p>
            <div className={cx.link}>
              <p className={cx.linkText}>
            ...
            <div className={cx.contactAndResumeWrapper}>
              ...
              <a className={cx.resume} href={resume} download>
                <span>download resume</span>
                <img src="./assets/download_2_line.svg" alt="" />
              </a>
            </div>
          </div>
        </section>
        ...
        <section className={cx.projectSection}>
          <div className={cx.one}>
            ...
            <div className={cx.right}>
              ...
              <p>
                {" "}
                Whether your goal is to generate leads, start selling, improve
                your ecommerce, build a converting blockchain website or have
                your own space in the digital world, connecting with the users’
                emotions is key.
              </p>
              <br />
              <p>
                That's why I design digital solutions that help create the
                connection between your business and customers by combining
                designs and creative ideas into a beautiful and usable products.
              </p>
              <br />
              <p>
                Using a pixel perfect approach, I ensure usability is taken care
                of to the last detail.
              </p>
            </div>
          </div>
        ...
        <section className={cx.workSection}>
          ...
          <div
            ...
            className={cx.workSectionImageContainer}
          />
        </section>
        <footer className={cx.footer}>
          ...
          <div className={cx.fBottom}>
            <div className={cx.code}>
              ...
              <span>
                code by <span className={cx.devName}>Emmanuel Ezeka</span>
              </span>{" "}
